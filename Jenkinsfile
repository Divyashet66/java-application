...
// //                         """
// 			IP = sh ('http://34.132.115.205:8080/')
...
// 	}
	    ...
	    stage('DAST') {
		    steps {
			    	sh 'docker run -t owasp/zap2docker-stable zap-baseline.py -t http://34.171.195.5:8080/ || true'
		    }
	    }
	...
	post{
        always{
            ...
            body: "${currentBuild.currentResult}: Job ${env.JOB_NAME}\nMore Info can be found here: ${env.JOB_URL}"
        }	
    }
